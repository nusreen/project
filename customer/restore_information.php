...
require_once "../config/configpdo.php";
    ...
    if (isset($_GET['logout'])) {
      ...
      if (isset($_GET['restore'])) {
        ...
        $stmt = $conn -> query("UPDATE user SET u_delete='1' WHERE id = $delete_id");
        $stmt -> execute();
        ...
        if ($stmt) {
            ...
            header("refresh:2; url=../customer/restore_information.php");
        } else {
    ...
    if (isset($_GET['delete'])) {
        ...
        $stmt = $conn -> query("DELETE FROM user WHERE id = $delete_id");
        $stmt -> execute();
...
<body>
    ...
    <section class="home-section">
        ...
        <div class="container bg">
            ...
            <div class=" h4 text-center alert alert-danger mb-4 mt-4" role="alert"> คืนค่าข้อมูลลูกค้า</div>
            <hr>
            <a href="cat_information.php" class="btn btn-secondary mb-4">กลับ</a>
            <table id="datatableid" class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    $stmt = $conn -> query("SELECT * FROM user WHERE u_delete='0' AND urole='0' ");
                    $stmt -> execute();
                    $user = $stmt -> fetchAll();
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="?restore=<?php echo $room['id'];  ?>"
                                ...
                                <a data-id="<?php echo $room['id']; ?>" href=" ?delete=<?php echo $room['id']; ?>"
