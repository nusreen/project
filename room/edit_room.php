...
<div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="../food/food.php">ข้อมูลอาหาร</a></li>
                </ul>
            </li>
    ...
    <div class="container my-5">
        <div class=" h4 text-center alert alert-info mb-4 mt-4" role="alert">แก้ไขข้อมูลห้องพัก</div>
        <form action="update_room.php" method="POST">
        <?php
                require_once "../config/configpdo.php";
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $stml = $conn->query("SELECT * FROM room WHERE id = $id");
                    $stml->execute();
                    $data = $stml->fetch();
                }
            ?>
            ...
            <div class="row py-2">
                <div class="col">
                    ...
                    <input type="number" name="id_room" value="<?= $data['id_room']; ?>" class="form-control" placeholder="ป้อนเลขที่ห้องพัก" maxlength="20"
                        oninvalid="setCustomValidity('ป้อนเลขที่ห้องพัก')" oninput="setCustomValidity('')" required>
                </div>
                <div class="col">
                    ...
                    <select name="roomtype" class="form-select" require>
                        <option value="<?= $data['roomtype']; ?>" selected hidden><?= $data['roomtype']; ?></option>
                ...
                <div class="col">
                    <label>ราคา</label>
                    <input type="number" name="roomprice" value="<?= $data['roomprice']; ?>" class="form-control" placeholder="ป้อนราคาห้องพัก" maxlength="20"
