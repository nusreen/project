...
require_once "../config/config_sqli.php";
    ...
    if (isset($_GET['logout'])) {
      ...
      if (isset($_GET['delete'])) {
        ...
        $stmt = "UPDATE food set f_status='0' WHERE id = $delete_id";
        $stmt = mysqli_query($conn, $stmt);

        if ($stmt) {
            $_SESSION['success'] = "ลบข้อมูลเรียบร้อยแล้ว";
            header("refresh:2; url=../food/show_food.php");
        } 
  }
...
<?php
    ...
    <div class="container bg">
        ...
        <div class=" h4 text-center alert alert-danger mb-4 mt-4" role="alert"> ข้อมูลอาหาร</div>
        <hr>
        <a href="add_food.php" class="btn btn-success mb-4"><i class="bi bi-plus-circle-fill"></i> เพิ่มข้อมูล</a>
        <a href="restore_food.php" class="btn btn-outline-info mb-4"><i class="bi bi-trash3"></i> คืนค่าข้อมูล</a>
        <table id="datatableid" class="table table-striped table-hover table-bordered">
            ...
            <tbody>
                <?php 
                    ...
                    $stmt = "SELECT * FROM food WHERE f_status='1'" ;
                    $food=mysqli_query($conn,$stmt);
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="edit_food.php?id=<?php echo $food['id']; ?>"
                            ...
                            <a data-id="<?php echo $food['id']; ?>"
                                href=" ?delete=<?php echo $food['id']; ?>"
