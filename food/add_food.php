            ...
            <form action="insert_food.php" method="POST">
                <div class="row py-2">
                    <div class="col">
                        ...
                        <input type="text" name="food_type" class="form-control" placeholder="ป้อนประเภทอาหาร"
                            oninvalid="setCustomValidity('กรุณาป้อนประเภทอาหาร')"
                            oninput="setCustomValidity('')" required>
                    </div>
                    <div class="col">
                        <label>ราคา</label>
                        <input type="number" name="price" class="form-control" placeholder="ป้อนราคาอาหาร"
