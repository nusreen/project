                ...
                <form action="binder.php" method="post" enctype="multipart/form-data">
                    <div class="container">
                        ...
                        <table width="800" border="0" align="center" cellpadding="0" cellspacing="2">
                            <th>วันที่ฝาก : <input type="datetime-local" name="deposit_date" required></th>
                            <br>
                            <th>วันที่รับคืน : <input type="datetime-local" name="return_date" required></th>
                        </table>
                        ...
                        <table style="width:100%" class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><input type="checkbox" name="cat_id[]" value="<?= $f['cat_id'] ?>" class="cat-checkbox form-check-input"></td>
                                        <td><?= $f['cat_name'] ?></td>
                                        <td><?= $f['sex'] ?></td>
                                        <td><?= $f['species'] ?></td>
                                        <td><?= $f['cat_food'] ?></td>
